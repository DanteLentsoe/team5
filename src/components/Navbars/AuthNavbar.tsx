...
type AuthNavBarType = {
  secondary: (routes: string | any[]) => any | boolean;
  logoText: string;
  rest?: any;
};
const AuthNavbar = ({ secondary, logoText, rest }: AuthNavBarType) => {
  // Chakra color mode
  ...
  if (((secondary as unknown) as boolean) === true) {
    navbarIcon = "white";
    navbarBg = "none";
    navbarBorder = "none";
  ...
  return (
    <Flex
      position={navbarPosition as ResponsiveValue<any> | undefined}
      top="16px"
      left="50%"
